...
# next step is to write the following in the terminal
# >> python setup.py sdist
# in my case that is python3.10 app20-python-package/setup.py sdist
# then >> pip install twine
# and to upload >> twine upload --skip-existing dist/*
# if you are an existing user on pypi


setup(
  name = 'invoicing-pdf',         #* Your package will have this name
  packages = ['app20-python-package/invoicing'],   #* Name the package again
